...
if (isset($_POST['submit']) && isset($_POST['id'])) {
    ...
    //  $adresseManager->readAddress($adresse);
    echo 'the following number will be deleted  ' . $adresse->getId();
    echo '</br>';
    $adresseManager->deleteAddress($adresse);
    echo "-------" . '</br>';
    echo 'Yep, the record has been deleted !';
}
?>
<!DOCTYPE html>
<html>
